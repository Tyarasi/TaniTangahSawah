...
<body id="page-top">
                ...
                <div class="container-fluid">
                    <div class="clearfix">
                        <div class="float-left">
                            <h1 class="h3 m-0 text-gray-800">Data Penjualan Barang Tahunan Tani Tangah Sawah</h1>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card shadow mb-4">
                                <div class="card-header"><b>Silakan isi data tahun penjualan!</b></div>
                                <div class="card-body">
                                    <form action="<?= base_url('laporan_penjualan_tahun/generate') ?>" method="POST">
                                        <div class="clearfix">
                                            <div class="float-left" style="margin-right: 10px;">
                                                <input type="number" name="tahun" id="tahun" class="form-control" placeholder="Masukkan Tahun" aria-describedby="basic-addon1">
                                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header"><b>Laporan Penjualan Barang Tahunan </b>
                                    <div class="float-right">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="add" class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    <td><b>Kode Transaksi Penjualan</td><b></b>
                                                    <td><b>Tanggal Penjualan</td></b>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($laporan as $item) :
                                                    ...
                                                    $total_harga2 += $item->jumlah_barang * $item->harga_jual;

                                                endforeach;

                                                foreach ($laporan as $barang) : ?>
                                                    <tr>
                                                        <td><?php echo $barang->kode_penjualan; ?></td>
                                                        <td><?php echo date('d M Y', strtotime($barang->tanggal_penjualan)); ?></td>
    ...
    <script>
        ...
        function exportToExcel() {
            ...
            saveBlob(blob, 'Laporan Penjualan Tahunan.xlsx');
        }
