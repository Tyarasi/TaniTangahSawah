...
<body id="page-top">
                ...
                <div class="container-fluid">
                    <div class="clearfix">
                        <div class="float-left">
                            <h1 class="h3 m-0 text-gray-800">Data Penjualan Barang Bulanan Tani Tangah Sawah</h1>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card shadow mb-4">
                                <div class="card-header"><b>Silakan isi data bulan penjualan!</b></div>
                                <div class="card-body">
                                    <form action="<?= base_url('laporan_penjualan_bulan/generate') ?>" method="POST">
                                        <div class="clearfix">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header"><b>Laporan Penjualan Barang Bulanan </b>
                                    <div class="float-right">
    ...
    <script>
        ...
        function exportToExcel() {
            ...
            saveBlob(blob, 'Laporan Penjualan Bulanan.xlsx');
        }
